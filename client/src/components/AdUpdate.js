...
const AdUpdate = (props) => {
    ...
    const updateAdHandler = (e) => {
        e.preventDefault();
        axios.put(`http://localhost:8000/api/ad/${id}`, { 
            campaignTitle,
            targetAddress,
            displayLink,
            description,
    ...
    return (
        <div className="col-sm-11 col-md-10 col-lg-8 mx-auto">
            <h2 className="my-4 py-4">Update Campaign</h2>
            ...
            <div className="col-12 d-flex justify-content-start">
                <form className="col-12 mt-4 d-flex justify-content-start" onSubmit={updateAdHandler}>
